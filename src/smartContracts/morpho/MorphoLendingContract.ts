...
export interface MorphoLendingContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DECIMALS_OFFSET"
      | "DOMAIN_SEPARATOR"
...
export interface MorphoLendingContract extends BaseContract {
  connect(runner?: ContractRunner | null): MorphoLendingContract;
  waitForDeployment(): Promise<this>;

  interface: MorphoLendingContractInterface;
