...
export interface FluidLendingContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface FluidLendingContract extends BaseContract {
  connect(runner?: ContractRunner | null): FluidLendingContract;
  waitForDeployment(): Promise<this>;

  interface: FluidLendingContractInterface;
