...
import type {
  FluidLendingContract,
  FluidLendingContractInterface,
} from "../FluidLendingContract";
...
export class FluidLendingContract__factory {
  static readonly abi = _abi;
  static createInterface(): FluidLendingContractInterface {
    return new Interface(_abi) as FluidLendingContractInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as FluidLendingContract;
  }
}
