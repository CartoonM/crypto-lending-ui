...
import type {
  VenusLendingContract,
  VenusLendingContractInterface,
} from "../VenusLendingContract";
...
export class VenusLendingContract__factory {
  static readonly abi = _abi;
  static createInterface(): VenusLendingContractInterface {
    return new Interface(_abi) as VenusLendingContractInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as VenusLendingContract;
  }
}
